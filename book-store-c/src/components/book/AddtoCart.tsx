...
const AddToCart = ({book}: Props) => {
	...
	return (
		<AddToCartStyle $added={cartAdded}>
			<div><InputText inputType={"number"} value={quantity} onChange={handleChange}/>
				<Button size={"small"} scheme={"normal"} onClick={handleIncrease}>+</Button>
				<Button size={"small"} scheme={"normal"} onClick={handleDecrease}>-</Button></div>
