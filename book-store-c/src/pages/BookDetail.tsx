...
const BookDetail = () => {
	...
	const {book, likeToggle, reviews, addReview} = useBook(book_id);
	...
	return (
		<BookDetailStyle>
			<header className={"header"}>
				...
				<Modal onClose={() => setIsImgOpen(false)} isOpen={isImgOpen}> <img src={getImgSrc(book.img)} alt={book.title}/></Modal>
				<div className={"info"}>
