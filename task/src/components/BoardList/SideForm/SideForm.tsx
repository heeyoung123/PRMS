...
const handleClick=()=>{
	...
	return (
		<div className={sideForm}>
			<input type={'text'}  className={input} autoFocus placeholder={'새로운 게시판 등록하기'} value={inputText} onBlur={handleOnBlur} onChange={handleChange}/>
			<FiCheck className={icon} onMouseDown={handleClick}/>
		</div>
	);
};
export default SideForm;
//blur mousDown, mousup click